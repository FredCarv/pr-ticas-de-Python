...
url_base= "https://pokeapi.co/docs/v2"

url_base = "https://pokeapi.co/api/v2/ability/{id or name}/"

def dicio_poke(id or name):
    url_nome = f"https://pokeapi.co/api/v2/pokemon/{id or name}/"
    response = requests.get(url_nome)
